...
public class koneksiJava {
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/java_to_database";
            ...
            do {
                ...
                switch (choice) {
                    ...
                    case 5:
                        ...
                        break;
                    default:
                        System.out.println("Anda melakukan kesalahan Silakan coba lagi.");
                }
            } while (choice != 5);
        } catch (SQLException e) {
            System.err.println("Koneksi Gagal dikarenakan " + e.getMessage());
        }
    }
